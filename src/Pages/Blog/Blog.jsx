...
const Blog = () => {
    return (
        <div className='container mx-auto shadow-xl bg-white rounded-lg md:p-9 p-2'>
            <header>
                <h1 className='text-5xl text-center mb-5 font-semibold'>Blog</h1>
            </header>
            <section>
                <h1 className='text-4xl mb-4 font-semibold'>What is Node? How does Node work?</h1>
            ...
            <section>
                <h1 className='text-4xl mb-4 font-semibold'>What is Cors?</h1>
                <div className='text-2xl'>
            ...
            <section>
                <h1 className='text-4xl mb-4 font-semibold'>How does the private route work?</h1>
                <div className='text-2xl'>
            ...
            <section>
                <h1 className='text-4xl mb-4 font-semibold'>Why are you using firebase? What other options do you have to implement authentication?</h1>
                <div className='text-2xl'>
